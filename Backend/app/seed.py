...
ACTIVITIES = [
    ...
    },
    {
        "emotion": "neutral",
        "type": "game",
        "title": "A Five-Minute Mind Reset",
...
def seed_activities(db: Session):
    ...
    if inserted:
        ...
        logging.getLogger(__name__).info("catalog_seeded count=%s", inserted)
