...
BADGES = [
    ...
    },
    {
        ...
        "name": "7-Day Streak",
        "icon": "🔥",
        "description": "Journal 7 consecutive days",
    },
    {
        "id": "streak_30",
    ...
    },
    {
        ...
        "name": "Mood Lifter",
        "icon": "💪",
        "description": "Improve valence 3 days in a row",
    },
    {
        "id": "chatty",
        "name": "Open Heart",
        "icon": "💬",
        "description": "Have 10 companion conversations",
    },
    {
        "id": "self_aware",
        "name": "Self Aware",
    ...
    },
    {
        ...
        "name": "Studio Regular",
        "icon": "📸",
        "description": "Use Mood Studio 10 times",
    },
]
...
def _check_badges(db, user_id, streak, total_entries):
    ...
    existing = {
        a.badge_id
        for a in db.query(UserAchievement)
    ...
    unique_emotions = (
        db.query(EmotionAnalysis.dominant_emotion)
        .join(JournalEntry)
        .filter(JournalEntry.user_id == user_id)
        .distinct()
        .count()
...
def get_gamification_stats(
    ...
    total_entries = (
        db.query(JournalEntry).filter(JournalEntry.user_id == current_user.id).count()
    )
